...
func NewSemanticError(facts Facts) (SemanticError, error) {
	...
	return SemanticError{
		...
		Rule: Rule{
			...
			NormalizedSnapshot: NormalizedRuleSnapshot{
				Name: SanitizeSnippet(winner.Rule.Name), Enabled: winner.Rule.Enabled,
