...
func TestCookieOverlayRetriesCommitAndClientScopeIsolation(t *testing.T) {
	...
	operation, err := runtime.Begin(context.Background(), clientRequest, codexAPIType, "cookie-operation-one", "preserve_conversation", testClientEvidence(nil, nil))
	if err != nil {
		t.Fatal(err)
	}
	...
	secondOperation, err := runtime.Begin(context.Background(), secondClientRequest, codexAPIType, "cookie-operation-two", "preserve_conversation", testClientEvidence(nil, nil))
	if err != nil {
		t.Fatal(err)
	}
	...
	explicitOperation, err := runtime.Begin(context.Background(), explicitClientRequest, codexAPIType, "cookie-operation-explicit", "preserve_conversation", testClientEvidence(nil, nil))
	if err != nil {
		t.Fatal(err)
	}
	...
	isolatedOperation, err := runtime.Begin(context.Background(), isolatedRequest, codexAPIType, "cookie-operation-three", "preserve_conversation", testClientEvidence(nil, nil))
	if err != nil {
		t.Fatal(err)
	}
...
func TestCookieAuthoritySwitchDiscardsOverlayAndMergeFailureFailsGate(t *testing.T) {
	...
	operation, err := runtime.Begin(context.Background(), clientRequest, codexAPIType, "cookie-switch", "preserve_conversation", testClientEvidence(nil, nil))
	if err != nil {
		t.Fatal(err)
	}
