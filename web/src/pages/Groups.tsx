      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-text-secondary mt-1">
            Manage provider groups and routing strategies
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div className="w-14 h-14 mb-3 bg-bg-tertiary rounded-xl flex items-center justify-center group-hover:bg-primary-light transition-colors">
            <svg
              className="w-8 h-8 text-text-secondary group-hover:scale-110 transition-transform"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center text-sm text-text-secondary">
        <div>{group.providers?.length || 0} Providers</div>
