...
import { API_BASE, STORAGE_KEYS, CONFIG_DEFAULTS, FORM_CONSTRAINTS } from './constants'
...
describe('CONFIG_DEFAULTS', () => {
  ...
  it('should have sensible defaults for circuit breaker', () => {
    ...
    expect(cb.DISABLE_DURATION_SECONDS).toBeGreaterThanOrEqual(cb.WINDOW_SECONDS)
  })
})
...
describe('FORM_CONSTRAINTS', () => {
  ...
  it('should have logical constraint values', () => {
    expect(FORM_CONSTRAINTS.MIN_ZERO).toBeLessThan(FORM_CONSTRAINTS.MIN_POSITIVE)
  })
})
