// Re-export all components from the split files for backwards compatibility
export type { SectionProps, FormActionsProps } from "./config-form-sections";
export { ModifiedBadge } from "./config-form-sections";
export { RoutingStrategySection } from "./config-form-sections";
