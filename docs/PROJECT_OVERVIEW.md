...
- **Downstream client identity** (`internal/codex/clientidentity/`): Resolves entry API Keys to a persistent client and legacy scope aliases shared by reference learning, continuity and sticky routing. Explicit Key binding preserves identity; conflicting established ownership is rejected.
